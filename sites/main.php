...
<!--            Hiển thị danh sách 4 sản phẩm mới nhất-->
            ...
            <div class="grid_1_of_4 images_1_of_4">
                <a href="#"><img src="<?php echo SITE_URL.'/upload/product/'.$product_latest['category_id'].'/'.$product_latest['image']?>" alt="" /></a>
                <h2><?php echo $product_latest['name']; ?></h2>
                <div class="price-details">
                    <div class="price-number">
                        <p><span class="rupees"><?php echo number_format($product_latest['price'],0,'','.');?>VNĐ</span></p>
                    </div>
                    <div class="add-cart">
